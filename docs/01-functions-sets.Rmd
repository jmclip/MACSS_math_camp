...
Most elections have many, many ballots cast. There is no point to voting since any individual ballot is unlikely to change the outcome of the election. Thus, everyone should abstain. | If $P$ is $\approx$ 0, then $PB<C$, so $R<0$ and the voter abstains.
...
* Assignment due TONIGHT (grace period -- look at canvas)
* Canvas FYI: due date vs grace period
* LABEL THINGS 
