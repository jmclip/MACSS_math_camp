...
* Let $L$ be any real number. Choose $\epsilon>0$. We need to show that there **does not** exist: 
...
* $f'(0)$
    ...
    $$\begin{aligned} \lim_{h \rightarrow 0 } f'(x) & = \lim_{h \rightarrow 0 } \frac{f(x+h)-f(x)}{ h   } \\ 
    & = \lim_{h \rightarrow 0 } \frac{f(0+h)-f(0)}{ h   } 
    &= \lim_{h \rightarrow 0 }\frac{f(h)-1000}{h}\\ 
    &= \lim_{h \rightarrow 0 }\frac{h^2-1000}{h} 
    \end{aligned}$$

* Our difference quotient will behave like $\frac{-1000}{h}$, so the limit doesn't exist when we evaluate at $x = 0$. 									
